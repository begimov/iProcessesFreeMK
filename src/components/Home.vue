        ...
        <div class="col" style="margin-top:30px">
          <div class="card bg-primary text-white">
            <div class="card-body p-3">
              <h2 class="m-0">Узнайте, когда стартует мастер-проект &laquo;Создание системы управления процессами&raquo;.<br>Участвуйте в&nbsp;мастер-проекте, чтобы внедрить систему управления процессами в&nbsp;вашей компании за&nbsp;4&nbsp;месяца.</h2>
            </div>
          </div>
        </div>
      </div>
